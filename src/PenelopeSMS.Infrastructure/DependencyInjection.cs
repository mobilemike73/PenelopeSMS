...
public static class DependencyInjection
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<MonitoringHtmlReportQuery>();
        ...
        services.AddScoped<DeliveryCallbackRepository>();
        services.AddScoped<RejectedDeliveryCallbackRepository>();
        ...
        services.AddSingleton<IAwsSqsClient, AwsSqsClient>();
